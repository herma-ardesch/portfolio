...
mood_gg <- CPE %>% 
  ...
  theme_minimal() +
  theme(rect = element_blank())
mood_gg + annotate(geom = "text", x = 0.75, y = 0.4, label = "Harpsichord Allegros")
