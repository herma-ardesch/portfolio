...
The harpsichord outliers in the previous plot (mood features) deserve extra attemtion. Let's compare the timbre of the harpsichord to that of the piano in two Self-Similarity Matrices (SSMs). An SSM compares a track to itself, resulting in a squared visual representation, mirrored in the diagonal. These SSMs focus on timbre.
