...
This scatter plot shows the valence vs. energy values, resulting in moods per track. Both authentic and modern performances range in mood from the lower left 'sad' quadrant, to low in the upper right 'happy' quadrant. This makes sense, because the corpus consists of slow (sad) and fast (happy) movements.

The authentic performances show a slightly higher energy level, except for the beginning and the middle part. Spotify calculates the energy level using a mix of features and mentions that *'energetic tracks feel fast, loud and noisy'*. The lines crossing may be caused by the strong preference of tempos around 80 BPM in the modern performances, whereas the authentic performances use a variety of slower tempos for some of these tracks.

Two outliers oof the authentic performances in this graph show a higer energy level. They are the first Allegro and the third Allegro di molto of the keyboard Sonata in A minor, played on harpsichord by Gabor Antalffy. He takes a
